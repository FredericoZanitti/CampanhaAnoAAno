...
begin
  if codcompeticao = '0' then
     f_gerais.preencherEstJogadoresPorAdversario(codtime, 'J')
  else
     f_gerais.preencherEstGosPorCompeticao(codcompeticao, 'J');
...
begin
  if codcompeticao = '0' then
     ...
     f_gerais.preencherEstGosPorCompeticao(codcompeticao, 'G');
...
begin
  if codcompeticao = '0' then
     ...
     f_gerais.preencherEstGosPorCompeticao(codcompeticao, 'M');
