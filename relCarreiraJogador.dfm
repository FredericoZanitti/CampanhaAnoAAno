object frmRelCarreiraJogador: TfrmRelCarreiraJogador
  ...
  object frxRelCarreiraJogadores: TfrxReport
    ...
    ReportOptions.LastChange = 44310.784711203710000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBRelCarreiraJogadoresperiodo: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBRelCarreiraJogadores."periodo"]')
          ParentFont = False
        end
      end
      ...
      object Footer1: TfrxFooter
        ...
        object Rich6: TfrxRichView
          ...
          RichEdit = {
            ...
            746F722052696368656432302031302E302E31393034317D5C766965776B696E
  ...
  object qryCarreiraJogadores: TFDQuery
    ...
    SQL.Strings = (
      ...
      '       ca_carreira.anoini,'
      '       case'
      #9#9#9'    when ca_carreira.anofim is null then '#39'Atual'#39
      '          else ca_carreira.anofim'
      '  '#9'   end as anofim,'
      ''
      '       case'
      
        '    '#9#9#9'when ca_carreira.anoini = ca_carreira.anofim then ca_carr' +
        'eira.anofim'
      
        '          when ca_carreira.anofim is null then concat(ca_carreir' +
        'a.anoini,'#39' / Atual'#39')'
      
        '          else concat(ca_carreira.anoini, '#39' / '#39', ca_carreira.ano' +
        'fim)'
      '  '#9'   end as periodo'
      'from ca_jogad'
    ...
    object qryCarreiraJogadoresperiodo: TWideStringField
      AutoGenerateValue = arDefault
      FieldName = 'periodo'
      Origin = 'periodo'
      ProviderFlags = []
