  ...
  begin
    ...
    begin
      ...
      begin
        ...
        //deletar todas os arquivos dos diretórios de backup
        MemScript.Lines.Add('del /f /q Escudos');
        MemScript.Lines.Add('del /f /q Jogadores');
        MemScript.Lines.Add('del /f /q BandeiraPaises');
        MemScript.Lines.Add('del /f /q BandeiraUF');
        MemScript.Lines.Add('del /f /q Patrocinadores');
        MemScript.Lines.Add('del /f /q Fornecedores');
        MemScript.Lines.Add('del /f /q Uniformes');
        MemScript.Lines.Add('del /f /q StoredProcedures');

        //deletar os diretórios
        MemScript.Lines.Add('rd Escudos');
        MemScript.Lines.Add('rd Jogadores');
        MemScript.Lines.Add('rd BandeiraPaises');
        MemScript.Lines.Add('rd BandeiraUF');
        MemScript.Lines.Add('rd Patrocinadores');
        MemScript.Lines.Add('rd Fornecedores');
        MemScript.Lines.Add('rd Uniformes');
        MemScript.Lines.Add('rd StoredProcedures');
