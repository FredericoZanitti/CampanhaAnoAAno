...
type
  ...
  public
    { Public declarations }
    procedure VerificarApresentacaoSumula(codigojogo: string);
  end;
...
begin
  VerificarApresentacaoSumula(LblCodMelhorResult1.Caption);
...
begin
  VerificarApresentacaoSumula(LblCodMelhorResult2.Caption);
...
begin
  VerificarApresentacaoSumula(LblCodMelhorResult3.Caption);
...
begin
  VerificarApresentacaoSumula(LblCodPiorResultado1.Caption);
...
begin
  VerificarApresentacaoSumula(LblCodPiorResultado2.Caption);
...
begin
  VerificarApresentacaoSumula(LblCodPiorResultado3.Caption);
...
procedure Tr_campanhageral.VerificarApresentacaoSumula(codigojogo: string);
begin
  ...
  if f_gerais.contRegComUmParametro('ES_TITUL', 'codjogo',codigojogo) = 0 then
  begin
