object h_federacao: Th_federacao
  Left = 0
  Top = 0
  Caption = 'Pesquisar federacao'
  ClientHeight = 327
  ClientWidth = 529
  Color = clWhite
  ...
  object Label1: TLabel
    ...
    Width = 226
    Height = 13
    Caption = 'Digite a descri'#231#227'o do federacao (ou parte dela)'
  end
  ...
  object DbGridfederacao: TDBGrid
    Left = 22
    Top = 72
    Width = 345
    Height = 180
    ...
    OnCellClick = DbGridfederacaoCellClick
    OnDrawColumnCell = DbGridfederacaoDrawColumnCell
    OnDblClick = DbGridfederacaoDblClick
    OnKeyUp = DbGridfederacaoKeyUp
    Columns = <
      item
        Expanded = False
      ...
      item
        Expanded = False
        FieldName = 'federacao'
        Title.Caption = 'Federa'#231#227'o'
        Width = 300
        Visible = True
      end>
  end
