object CA_CIDAD: TCA_CIDAD
  ...
  object Label6: TLabel
    ...
    Width = 296
    Height = 13
    Caption = 'Selecione o Estado (se n'#227'o for Brasil, selecionar EX - Exterior)'
  end
  object CbxPaisNovaCidade: TComboBox
    Left = 102
    Top = 41
    Width = 367
    Height = 33
    ...
    ParentFont = False
    TabOrder = 0
    OnChange = CbxPaisNovaCidadeChange
  end
  ...
  object EdtNomeCidade: TDBEdit
    ...
    ParentFont = False
    TabOrder = 5
    OnEnter = EdtNomeCidadeEnter
    OnExit = EdtNomeCidadeExit
  end
  ...
  object CbxUfNovaCidade: TComboBox
    Left = 102
    Top = 113
    Width = 367
    Height = 33
    ...
    ParentFont = False
    TabOrder = 1
    OnChange = CbxUfNovaCidadeChange
  end
