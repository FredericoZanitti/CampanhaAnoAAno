...
type
  Tr_sumula = class(TForm)
    ...
    imgGols: TImage;
    ImgBandJogRes1: TImage;
    ImgBandJogRes2: TImage;
    ImgBandJogRes3: TImage;
    ImgBandJogRes4: TImage;
    ImgBandJogRes8: TImage;
    ImgBandJogRes7: TImage;
    ImgBandJogRes6: TImage;
    ImgBandJogRes5: TImage;
    ImgBandJogRes11: TImage;
    ImgBandJogRes10: TImage;
    ImgBandJogRes9: TImage;
