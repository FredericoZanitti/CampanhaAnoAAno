...
uses
  ...
  frameSelecionarContinente in 'frameSelecionarContinente.pas' {fraSelContinente: TFrame},
  federacao in 'federacao.pas' {CA_FEDERACAO},
  pesquisafederacao in 'pesquisafederacao.pas' {h_federacao};
...
begin
  ...
  Application.CreateForm(TCA_FEDERACAO, CA_FEDERACAO);
  Application.CreateForm(Th_federacao, h_federacao);
  // Tela de Splash
  FrmSplash.Show;
  FrmSplash.Refresh;
  Sleep(cTtempo);
