...
type
  TCA_ADVER = class(TForm)
    ...
    GroupBox1: TGroupBox;
    ImgFederacao: TImage;
    dblFederacao: TDBLookupComboBox;
    lblFederacao: TLabel;
    edtCodigoFederacao: TDBEdit;
    ...
    procedure dblFederacaoClick(Sender: TObject);
  private
...
begin
  ...
  lblFederacao.Caption := dblFederacao.Text;
  ...
  begin
    ...
    dblFederacao.Enabled := False;
    dblFederacao.Visible := False;
    lblFederacao.Visible := True;
  end;
  ...
  begin
    ...
    dblFederacao.Enabled := true;
    dblFederacao.Visible := true;
    lblFederacao.Visible := false;
  end;
  ...
  begin
    ...
    //buscar logo da federação
    if not (FrmDm.DtsAdversarios.DataSet.State in [dsInsert]) then
       f_gerais.buscaLogoFederacaoPorCodigo(ImgFederacao, dblFederacao.KeyValue)
    else
       ImgFederacao.Picture.Graphic := nil;
...
procedure TCA_ADVER.dblFederacaoClick(Sender: TObject);
begin
   f_gerais.buscaLogoFederacaoPorCodigo(ImgFederacao, dblFederacao.KeyValue);
end;
