  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          MemScript.Lines.Add('del /f /q "' + EdtRestaurar.Text + '\Escudos"');
          MemScript.Lines.Add('echo.');
        ...
        begin
          MemScript.Lines.Add('del /f /q "' + EdtRestaurar.Text + '\Patrocinadores"');
          MemScript.Lines.Add('echo.');
        ...
        begin
          MemScript.Lines.Add('del /f /q "' + EdtRestaurar.Text + '\Fornecedores"');
          MemScript.Lines.Add('echo.');
        ...
        begin
          MemScript.Lines.Add('del /f /q "' + EdtRestaurar.Text + '\Uniformes"');
          MemScript.Lines.Add('echo.');
        ...
        begin
          MemScript.Lines.Add('del /f /q "' + EdtRestaurar.Text + '\Jogadores"');
          MemScript.Lines.Add('echo.');
        ...
        begin
          MemScript.Lines.Add('del /f /q "' + EdtRestaurar.Text + '\BandeiraPaises"');
          MemScript.Lines.Add('echo.');
        ...
        if ChkBandPais.Checked then
        begin
          MemScript.Lines.Add('del /f /q "' + EdtRestaurar.Text + '\BandeiraUF"');
          MemScript.Lines.Add('echo.');
        ...
        MemScript.Lines.Add('del /f /q "' + EdtRestaurar.Text + '\StoredProcedures"');
        MemScript.Lines.Add('echo.');
        MemScript.Lines.Add('echo Copiando arquivos... Procedures');
        MemScript.Lines.Add('echo.');
        MemScript.Lines.Add('ping -n 3 127.0.0.1 > nul');
        ...
        MemScript.Lines.Add('echo Aguarde, o programa sera executado');
        MemScript.Lines.Add('echo.');
        MemScript.Lines.Add('echo.');
        MemScript.Lines.Add('pause');
        MemScript.Lines.Add('cd ' + EdtRestaurar.Text);
        MemScript.Lines.Add('cd..');
        MemScript.Lines.Add('cd..');
        MemScript.Lines.Add('start ' + nomeApp);
