  ...
  object qryGolsJogo: TFDQuery
    ...
    SQL.Strings = (
      ...
      '    CASE WHEN es_gols.fracao = '#39'Minutos'#39
        ...
        ' es_gols.periodo, '#39' )'#39', CASE WHEN es_tipogol.tipo = '#39'Penalti'#39' TH' +
        'EN '#39' ( Penalti )'#39' ELSE '#39#39' END, '#39'; '#39')'
      
        '         ELSE CONCAT('#39' ( '#39', CAST(es_gols.tempo AS CHAR), '#39'" '#39', e' +
        's_gols.periodo, '#39' )'#39', CASE WHEN es_tipogol.tipo = '#39'Penalti'#39' THEN' +
        ' '#39' ( Penalti )'#39' ELSE '#39#39' END, '#39'; '#39')'
      #9'  END tempoTipo'
      'FROM es_gols'
