...
type
  TFrmDm = class(TDataModule)
    ...
    TblJogadoresnaturalizado: TWideStringField;
    TblJogadorescodpais: TIntegerField;
    TblJogosobservacao: TWideStringField;
    tblParametros: TFDTable;
    tblParametrosCodigoParametro: TFDAutoIncField;
    tblParametrosDescricao: TWideStringField;
    tblParametrosValor: TWideStringField;
    ...
    TblPaiscodcontinente: TIntegerField;
    TblPaisiso3: TWideStringField;
    TblPaisiso2: TWideStringField;
    TblPaisfifa: TWideStringField;
    TblPaiscoi: TWideStringField;
    TblPaisisonumerico: TIntegerField;
    tblContinente: TFDTable;
    dtsContinente: TDataSource;
    tblContinentecodcontinente: TFDAutoIncField;
    tblContinentedescricao: TWideStringField;
    TblAdversarioscodfederacao: TIntegerField;
    tblFederacao: TFDTable;
    dtsFederacao: TDataSource;
    tblFederacaocodfederacao: TFDAutoIncField;
    tblFederacaofederacao: TWideStringField;
    tblFederacaobrasao: TWideStringField;
  private
