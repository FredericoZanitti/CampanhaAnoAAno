...
type
  Tr_aniversariantes = class(TForm)
    ...
    Shape2: TShape;
    lblIdade: TLabel;
    LblIdadeJogador3: TLabel;
    LblIdadeJogador4: TLabel;
    LblIdadeJogador5: TLabel;
    LblIdadeJogador6: TLabel;
    LblIdadeJogador7: TLabel;
    LblIdadeJogador8: TLabel;
    LblIdadeJogador9: TLabel;
    LblIdadeJogador10: TLabel;
    LblIdadeJogador11: TLabel;
    LblIdadeJogador12: TLabel;
    LblIdadeJogador13: TLabel;
    LblIdadeJogador14: TLabel;
    LblIdadeJogador15: TLabel;
    LblIdadeJogador2: TLabel;
