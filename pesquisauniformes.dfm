object h_uniformes: Th_uniformes
  Left = 0
  Top = 0
  Caption = 'Pesquisar Uniformes'
  ClientHeight = 327
  ClientWidth = 529
  Color = clWhite
  ...
  object Label1: TLabel
    ...
    Width = 219
    Height = 13
    Caption = 'Digite a descri'#231#227'o do uniforme (ou parte dela)'
  end
  ...
  object DbGridUniforme: TDBGrid
    ...
    OnCellClick = DbGridUniformeCellClick
    OnDrawColumnCell = DbGridUniformeDrawColumnCell
    OnDblClick = DbGridUniformeDblClick
    OnKeyUp = DbGridUniformeKeyUp
    Columns = <
      item
        Expanded = False
